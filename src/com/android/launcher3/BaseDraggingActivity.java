    ...
    protected void updateTheme(WallpaperColorInfo wallpaperColorInfo) {
        ...
        switch (systemTheme) {
            ...
            case 4: case 6: case 8:
                setTheme(supportsDarkText ? R.style.LauncherThemeShishu_DarKText : R.style.LauncherThemeShishuThemes);
                break;
            case 5:
                setTheme(supportsDarkText ? R.style.LauncherThemeShishu_DarKText : R.style.LauncherThemeShishuNightsTheme);
                break;
            case 7:
                setTheme(supportsDarkText ? R.style.LauncherThemeShishu_DarKText : R.style.LauncherThemeShishuImmensityTheme);
                break;
            default:
                setTheme(mThemeRes);
                break;
